...
9  = Stargate Medieval Resistance 
10 = Stargate Jaffa Free Nation Resistance */
...
8  = Stargate Medieval Civilians
9  = Stargate Modern Civilians
10 = Stargate Future Civilians */
...
blacklisted_from_arsenal = [
    ...
    "sga_jaffa_holiday",
    "personal_shield",
    "YSA_TacticalVest_Black",
    "SGA_test_vest",
    "SGA_sgc_vest",
    "sga_jaffa_closed_serpent_headgear",
    "sga_jaffa_open_serpent_headgear",
    "sga_jaffa_closed_serpent_headgear_1",
    "sga_jaffa_gold_closed_serpent_headgear",
    "sga_jaffa_gold_open_serpent_headgear",
    "sga_jaffa_red_closed_serpent_headgear",
    "sga_jaffa_red_open_serpent_headgear",
    "sga_jaffa_black_closed_serpent_headgear",
    "sga_jaffa_black_open_serpent_headgear",
    "sga_jaffa_plate_headgear",
    "sga_jaffa_plate_headgear_gold",
    "anubis_helmet",
    "sga_commoner_hat_gear",
    "sga_horus_headgear",
    "sga_knight_helmet",
    "sga_ori_semi_helmet",
    "sga_prior_hood",

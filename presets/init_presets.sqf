...
switch (KP_liberation_preset_blufor) do {
    ...
    case 31: {[] call compileFinal preprocessFileLineNumbers "presets\blufor\sg_sgc.sqf";};
    case 32: {[] call compileFinal preprocessFileLineNumbers "presets\blufor\sg_atlantis.sqf";};
...
switch (KP_liberation_preset_opfor) do {
    ...
    case 21: {[] call compileFinal preprocessFileLineNumbers "presets\opfor\sg_goauld.sqf";};
    case 22: {[] call compileFinal preprocessFileLineNumbers "presets\opfor\sg_ori.sqf";};
...
switch (KP_liberation_preset_resistance) do {
    ...
    case  9: {[] call compileFinal preprocessFileLineNumbers "presets\resistance\sg_medieval.sqf";};
    case 10: {[] call compileFinal preprocessFileLineNumbers "presets\resistance\sg_jaffa.sqf";};
...
switch (KP_liberation_preset_civilians) do {
    ...
    case  8: {[] call compileFinal preprocessFileLineNumbers "presets\civilians\sg_medieval.sqf";};
    case  9: {[] call compileFinal preprocessFileLineNumbers "presets\civilians\sg_modern.sqf";};
    case 10: {[] call compileFinal preprocessFileLineNumbers "presets\civilians\sg_future.sqf";};

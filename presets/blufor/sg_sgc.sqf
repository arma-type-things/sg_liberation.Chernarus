...
huron_typename = "B_Heli_Transport_03_unarmed_F";                       // This is not the Daedalus, a multipurpose mobile respawn as a helicopter.
...
*/
infantry_units = [
    ["sga_sg1_wood_base_p90",15,0,0],                                   // SG team member
    ["sga_sg1_wood_base_spas12",15,0,0],                                // SG assault member
    ["sga_sg1_wood_base_usas12",15,0,0],                                // SG defense member
    ["sga_sg1_black_base_p90",15,0,0],                                  // SG specialist team member
    ["sga_sg1_black_base_spas12",15,0,0],                               // SG specialist assault member
    ["sga_sg1_black_base_usas12",15,0,0],                               // SG specialist defense member
    ["sga_sg1_olive_base_p90",15,0,0],                                  // SG SGC team member
    ["sga_sg1_olive_base_spas12",15,0,0],                               // SG SGC assault member
    ["sga_sg1_olive_base_usas12",15,0,0],                               // SG SGC defense member
...
air_vehicles = [
    ...
    ["SG_f302_plane",5500,2000,100]
];

static_vehicles = [
    ["sga_m2_browning",24,30,0],
...
support_vehicles = [
    ...
    ["SGA_MALP",50,0,0],
    ["SGA_MALP_CARRYALL",150,0,0],
    ["SGA_MALP_CARRYON",250,0,0],
    ["SGA_MALP_carryPerson",250,0,0],
    ["SGA_MALP_MAT",450,0,0],
    ["SGA_MALP_NUKE",150000,0,0],
...
blufor_squad_inf_light = [
    "sga_sg1_wood_base_p90",
    "sga_sg1_wood_base_p90",
    "sga_sg1_wood_base_p90",
    "sga_sg1_wood_base_spas12",
    "sga_sg1_wood_base_usas12",
    "B_soldier_AR_F",
    "B_soldier_AR_F",
    "B_soldier_M_F",
    "B_medic_F",
